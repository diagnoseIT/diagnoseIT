...
public class TimeWastingOperationsRule {
	...
	public List<AbstractAggregatedTimedCallable<? extends TimedCallable>> action() {
		System.out.println("TimeWastingOperationsRule wird gefeuert!");
		...
		// Sort the aggregatedCallables with their exclusive times (descendant)
		...
		// for Testing
		for (AbstractAggregatedTimedCallable<? extends TimedCallable> timeWastingOp : timeWastingOperations) {
			System.out.println("Anzahl Elemente in der timeWastingOperation: "
					+ timeWastingOp.getCallables().size());
			System.out
					.println("Folgende Elemente sind in der timeWastingOperation enthalten: "
							+ timeWastingOp.getCallables());
			System.out.println("Das ist der Typ der timeWastingOperation: "
