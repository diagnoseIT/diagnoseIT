...
public class ApplicationHiccupsRule {
	...
	public List<DataPointTraceID> action() {
		System.out.println("Executing ApplicationHiccupsRule..");
		...
		double upperWhiskerThreshold = upperQuartile + interquartileRange
				* 1.5;
		// System.out.println("ApplicationHiccupsRule: Upper whisker threshold: "
		// + upperWhiskerThreshold);
		...
		// System.out.println("ApplicationHiccupsRule: Problematic Data Points: "
		// + "response time: "
		...
		if (problematicDataPoints.size() < 1) {
			System.out.println("ApplicationHiccupsRule: No Application Hiccups detected.");
			return problematicDataPoints;
		}

		System.out.println("ApplicationHiccupsRule: Amount of Application Hiccups: "
