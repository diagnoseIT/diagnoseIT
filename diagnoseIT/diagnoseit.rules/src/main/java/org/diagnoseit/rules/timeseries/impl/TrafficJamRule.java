...
public class TrafficJamRule {
	...
	public boolean action() {
		System.out.println("Executing TrafficJamRule..");
		...
		if (Math.abs(regression.getSlope()) <= SLOPE_THRESHOLD) {
			...
			System.out
					.println("TrafficJamRule: Coefficient of variation = " + coeffOfVariation);
			...
			System.out.println("TrafficJamRule: Slope is to high for Traffic Jam.");
			return false;
		}

		if (trafficJamDetected) {
			System.out.println("TrafficJamRule: Variance of response times detected.");
		} else {
			System.out.println("TrafficJamRule: No variance of response times detected.");
		}
