...
public class TheRampRule {
	...
	public boolean action() {
		...
		System.out.println("Slope of the regression line = "
				+ regression.getSlope());
		...
		if (rampDetected) {
			System.out.println("Rise of response times detected.");
		} else {
			System.out.println("No rise of response times detected.");
		}
		return rampDetected;
	}
